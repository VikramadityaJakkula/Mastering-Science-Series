...
public partial class Quiz : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (PreviousPage != null && PreviousPage.IsCrossPagePostBack == true)
            {
                ...
                else if (quizID == "0EB2C22A-DDF4-4565-B97D-293795C31655" || quizID == "CB6BD55A-C356-4ff7-AB5E-10D471A64492" || quizID == "0134BBB6-EA9E-4556-8313-987B84C03F70")
                    ViewState["QuizType"] = "Discount";
                else if (quizID == "76F8CD7A-4BF6-49b6-A440-1C2D87CA2DCE" || quizID == "573ACD8A-F063-4119-8DB5-08E5D7B7F095" || quizID == "4268C829-71F0-4541-BECC-0788904230B8" ||
   ...
   "<br>&nbsp;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;";
        ...
        else if (ViewState["QuizType"].ToString() == "Currency")
        {
            answer.Text = "<br>" + Question +
          "<br>&nbsp;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;<br>&nbsp;&nbsp;&nbsp;" +
          quiz.questionaire.ElementAt(quiz.presentQuestion).answer +
        ...
        /* if (Request.Cookies["StudentMode"] != null)
          {
              ...
              return;
          */
        //if (AnimationLinkButton.Text == "View Animation")
        //    AnimationLinkButton.Text = "Comming Soon..";
        //else
        //    AnimationLinkButton.Text = "View Animation";
        anime.Attributes["src"] = "Videos/Videos.htm";
        MainMultiView.SetActiveView(animationView);
    ...
    protected void tutorialLinkButton_Click(object sender, EventArgs e)
    {
        ...
        //MainMultiView.SetActiveView(tutorialView);
        tutorial.Attributes["src"] = "Videos/Videos.htm";
        MainMultiView.SetActiveView(tutorialView);
    ...
    {
        //if (VideoLinkButton.Text == "View Video")
        //    VideoLinkButton.Text = "Comming Soon..";
        //else
        //    VideoLinkButton.Text = "View Video";
        ...
        //else
        video.Attributes["src"] = "Videos/Videos.htm";
