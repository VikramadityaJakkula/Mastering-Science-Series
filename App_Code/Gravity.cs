...
namespace ArithmeticHelper
{
     class Gravity : Quiz
    {
         protected float Answer,Start_Speed, End_Speed, Time_Taken, Distance_Traveled;
        protected int MaxCount, QnsNo;
        protected float Travel_Gravity =  (98/10);
        ...
        protected override String createQuestion()
        {
            ...
            question.Replace("Travel_Gravity", Travel_Gravity.ToString());
        ...
        protected string createQns()
        {
            ...
            MaxCount = objDoc.SelectNodes("Questions//Gravity//Qns").Count;
            QnsNo = randomDigit(0, MaxCount);
            lst = objDoc.SelectNodes("Questions//Gravity//Qns");
        ...
        protected int generateTravel_Gravity()
        {
            int Number1;
        ...
        protected float CalculateTraveled_Speed()
        {
            return Travel_Gravity * Time_Taken;
        }
        protected float CalculateEnd_Speed()
        {
            return Start_Speed + (Travel_Gravity * Time_Taken);
        }



        protected float CalculateDistance_Traveled()
        {
            return Start_Speed * Time_Taken + (Travel_Gravity * Time_Taken * Time_Taken) / 2;
        ...
        protected String buildSolution()
        {
            ...
            s.Replace("Travel_Gravity", Travel_Gravity.ToString());
